...
SRC_URI = "git://git@gitlab.com/polyvection/u-boot-mainline-pv.git;protocol=ssh;branch=v2018.09_pv \
           file://boot.cmd \
           "
...
do_deploy_append() {
    cp ${WORKDIR}/build/u-boot-sunxi-with-spl.bin ${DEPLOY_DIR_IMAGE}/u-boot.sunxi
}
