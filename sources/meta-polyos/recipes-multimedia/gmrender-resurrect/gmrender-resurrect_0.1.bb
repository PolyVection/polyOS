...
DEPENDS = "initscripts libdaemon libconfig libupnp1.6 gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav alsa-lib"
LICENSE = "GPLv2"
...
RDEPENDS_${PN} = "initscripts libdaemon libconfig libupnp1.6 gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav"
